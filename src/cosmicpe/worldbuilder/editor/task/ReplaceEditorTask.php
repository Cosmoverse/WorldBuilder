...
class ReplaceEditorTask extends EditorTask{

	/** @var array<int, int> */
	readonly private array $replacement_map;

	public function __construct(World $world, Selection $selection, BlockToBlockReplacementMap $replacement_map, bool $generate_new_chunks){
